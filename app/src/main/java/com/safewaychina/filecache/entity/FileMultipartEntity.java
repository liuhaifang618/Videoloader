package com.safewaychina.filecache.entity;
 ...
 */
public class FileMultipartEntity implements HttpEntity {
    ...
    private final FileResponse progressHandler;

    private int bytesWritten;

    private int totalSize;

    public FileMultipartEntity(FileResponse progressHandler) {
    ...
    public void addPart(String key, String streamName, InputStream inputStream, String type)
        ...
        FileLoaderEngine.silentCloseOutputStream(out);
    }

    private String normalizeContentType(String type) {
        return type == null ? FileRequestParams.APPLICATION_OCTET_STREAM : type;
    }

    private byte[] createContentType(String type) {
        String result = FileLoaderEngine.HEADER_CONTENT_TYPE + ": " + normalizeContentType(type) + STR_CR_LF;
        return result.getBytes();
    }

    private byte[] createContentDisposition(String key) {
        return (
                FileLoaderEngine.HEADER_CONTENT_DISPOSITION +
    ...
    private class FilePart {
        ...
        public void writeTo(OutputStream out) throws IOException {
            ...
            out.flush();
            FileLoaderEngine.silentCloseInputStream(inputStream);
        }
    }
    ...
    public Header getContentType() {
        return new BasicHeader(
            FileLoaderEngine.HEADER_CONTENT_TYPE,
